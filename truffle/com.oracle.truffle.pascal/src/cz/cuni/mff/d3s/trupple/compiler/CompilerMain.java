...
/**
 * Pascal Truffle implementation from:
 * https://github.com/Aspect26/TrufflePascal/tree/master/PascalCompiler
 *
...
public class CompilerMain {
    ...
    private static class Settings {
        @Option(name = "-v", usage = "make compiler verbose") public boolean verbose;

        @Option(name = "-I", handler = ImportsOptionHandler.class, usage = "specifies directories, where unit .tpa files are located") public List<String> imports = new ArrayList<>();

        @Argument public List<String> arguments = new ArrayList<>();
